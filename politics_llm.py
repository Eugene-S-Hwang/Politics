...
vectorstore = Chroma(persist_directory="./chroma_politics/", embedding_function=embedding)
...
system_prompt = (
    ...
    If you don't know the answer just say that you don't know and to email the program, 
    never try to make up an answer. Use three sentences maximum. 
...
st.title("Ask Anything About Politicians")
